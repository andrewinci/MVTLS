...
\item 
void \hyperlink{_server_client_handshake_protocol_8h_a17a2f489bf364bdd80fbd20d186f927e}{print\+\_\+handshake} (\hyperlink{structhandshake__t}{handshake\+\_\+t} $\ast$h, int \hyperlink{server_8c_a1bdcfae3209cbd96db35a2ae356fa15e}{verbosity}, \hyperlink{_t_l_s_constants_8h_a7203e83530e35d8ed2f3300ba0408a54}{key\+\_\+exchange\+\_\+algorithm} kx)
\item 
...
alloc and return a handshake struct
\end{DoxyReturn}
De-\/serialize a stream of byte into an handshake.
...
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
return the de-\/serialized handshake message 
\end{DoxyReturn}
...
\begin{DoxyParams}{Parameters}
{\em h} & the handshake to be freed \\
\hline
\end{DoxyParams}
...
\hline
{\em verbosity} & how many details to print (0 none, 1 the binary, 2 details,3 record) \\
\hline
...
{\em verbosity} & how many details to print (0 none, 1 the binary, 2 details, 3 record) \\
\hline
{\em kx} & the key exchange algorithm, useful in key\+\_\+exchange messages \\
\hline
\end{DoxyParams}
...
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
1 if the send is succeeded, 0 otherwise
\end{DoxyReturn}

\hypertarget{_t_l_s_8c}{}\section{src/\+T\+LS.c File Reference}
\label{_t_l_s_8c}\index{src/\+T\+L\+S.\+c@{src/\+T\+L\+S.\+c}}
{\ttfamily \#include \char`\"{}T\+L\+S.\+h\char`\"{}}\\*
Include dependency graph for T\+L\+S.\+c\+:\nopagebreak
\begin{figure}[H]
\begin{center}
\leavevmode
\includegraphics[width=350pt]{_t_l_s_8c__incl}
\end{center}
\end{figure}
...
\item 
void \hyperlink{_t_l_s_8c_aef2a72a9807aac60336cd3febe51a130}{make\+\_\+\+R\+S\+A\+\_\+client\+\_\+key\+\_\+exchange} (\hyperlink{struct_t_l_s__parameters__t}{T\+L\+S\+\_\+parameters\+\_\+t} $\ast$\hyperlink{server_8c_aa8eef32066e04e25183a0cc549992c54}{T\+L\+S\+\_\+param}, \hyperlink{structclient__key__exchange__t}{client\+\_\+key\+\_\+exchange\+\_\+t} $\ast$client\+\_\+key\+\_\+ex)
\item 
void \hyperlink{_t_l_s_8c_ace7876fa0df923e8b3c924a7a046a1ff}{make\+\_\+\+D\+H\+E\+\_\+client\+\_\+key\+\_\+exchange} (\hyperlink{struct_t_l_s__parameters__t}{T\+L\+S\+\_\+parameters\+\_\+t} $\ast$\hyperlink{server_8c_aa8eef32066e04e25183a0cc549992c54}{T\+L\+S\+\_\+param}, \hyperlink{structclient__key__exchange__t}{client\+\_\+key\+\_\+exchange\+\_\+t} $\ast$client\+\_\+key\+\_\+ex)
\item 
void \hyperlink{_t_l_s_8c_a6f7128cf62e8491d70cf2585cf901c4c}{make\+\_\+\+E\+C\+D\+H\+E\+\_\+client\+\_\+key\+\_\+exchange} (\hyperlink{struct_t_l_s__parameters__t}{T\+L\+S\+\_\+parameters\+\_\+t} $\ast$\hyperlink{server_8c_aa8eef32066e04e25183a0cc549992c54}{T\+L\+S\+\_\+param}, \hyperlink{structclient__key__exchange__t}{client\+\_\+key\+\_\+exchange\+\_\+t} $\ast$client\+\_\+key\+\_\+ex)
\item 
...
This file provide a set of function for the T\+LS handshake. The function are used to make T\+LS message for both server and client.
...
\begin{center}
\leavevmode
\includegraphics[width=328pt]{_t_l_s_8c_a12a63a5becca8f85a59f6ac0f4d9c553_cgraph}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{_t_l_s_8c_a12a63a5becca8f85a59f6ac0f4d9c553_icgraph}
\end{center}
\end{figure}
...
Make the certificate message for the server. That message depends on the authentication algorithm hence we require the connection parameters. The function also sets the certificate in the connection parameters for further uses.
...
\begin{center}
\leavevmode
\includegraphics[width=342pt]{_t_l_s_8c_a6fd919275c5d6d3e6578c480cc62a8ce_cgraph}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{_t_l_s_8c_a6fd919275c5d6d3e6578c480cc62a8ce_icgraph}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{_t_l_s_8c_a5bed323f749e27db36fd6ab2a3e64c4a_icgraph}
\end{center}
\end{figure}
...
Given an array of cipher suites, make a client hello message. The function also fills the random field using the time stamp and a random generator (Open\+S\+SL)


\begin{DoxyParams}{Parameters}
{\em client\+\_\+random} & the random set in the client hello \\
\hline
{\em cipher\+\_\+suite\+\_\+list} & an array of cipher suites to add to the client hello \\
\hline
{\em cipher\+\_\+suite\+\_\+len} & the number of cipher suites in the list \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
...
\begin{center}
\leavevmode
\includegraphics[width=330pt]{_t_l_s_8c_a7c6bc0a015a0a78cb508614995b9172e_cgraph}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{_t_l_s_8c_a7c6bc0a015a0a78cb508614995b9172e_icgraph}
\end{center}
\end{figure}
...
Given the information in T\+L\+S\+\_\+parameter and the key exchange algorithm return the handshake of the client key exchange. That includes to compute the pre-\/master key. It also computes the master secret and set it in T\+L\+S\+\_\+param.
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{_t_l_s_8c_ab3bb4e3f75fb84baa35cd0931381dfe0_cgraph}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{_t_l_s_8c_ab3bb4e3f75fb84baa35cd0931381dfe0_icgraph}
\end{center}
\end{figure}
...
\subsubsection[{\texorpdfstring{make\+\_\+\+D\+H\+E\+\_\+client\+\_\+key\+\_\+exchange(\+T\+L\+S\+\_\+parameters\+\_\+t $\ast$\+T\+L\+S\+\_\+param, client\+\_\+key\+\_\+exchange\+\_\+t $\ast$client\+\_\+key\+\_\+ex)}{make_DHE_client_key_exchange(TLS_parameters_t *TLS_param, client_key_exchange_t *client_key_ex)}}]{\setlength{\rightskip}{0pt plus 5cm}void make\+\_\+\+D\+H\+E\+\_\+client\+\_\+key\+\_\+exchange (
\begin{DoxyParamCaption}
\item[{{\bf T\+L\+S\+\_\+parameters\+\_\+t} $\ast$}]{T\+L\+S\+\_\+param, }
\item[{{\bf client\+\_\+key\+\_\+exchange\+\_\+t} $\ast$}]{client\+\_\+key\+\_\+ex}
\end{DoxyParamCaption}
)}\hypertarget{_t_l_s_8c_ace7876fa0df923e8b3c924a7a046a1ff}{}\label{_t_l_s_8c_ace7876fa0df923e8b3c924a7a046a1ff}
Make the client key exchange message for D\+HE key exchange. This function is called from make\+\_\+client\+\_\+key\+\_\+exchange if the key exchange is D\+HE.


\begin{DoxyParams}{Parameters}
{\em client\+\_\+key\+\_\+ex} & the client key exchange message \\
\hline
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{_t_l_s_8c_ace7876fa0df923e8b3c924a7a046a1ff_cgraph}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{_t_l_s_8c_ace7876fa0df923e8b3c924a7a046a1ff_icgraph}
\end{center}
\end{figure}
...
Make the server key exchange for D\+HE key exchange. It computes the DH parameters and save the message in the connection parameters T\+L\+S\+\_\+param.
...
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
the dhe\+\_\+server\+\_\+key\+\_\+exchange struct 
\end{DoxyReturn}
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{_t_l_s_8c_a359e2b0b51c61744f7a70b5888d8c2db_cgraph}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{_t_l_s_8c_a359e2b0b51c61744f7a70b5888d8c2db_icgraph}
\end{center}
\end{figure}
...
\subsubsection[{\texorpdfstring{make\+\_\+\+E\+C\+D\+H\+E\+\_\+client\+\_\+key\+\_\+exchange(\+T\+L\+S\+\_\+parameters\+\_\+t $\ast$\+T\+L\+S\+\_\+param, client\+\_\+key\+\_\+exchange\+\_\+t $\ast$client\+\_\+key\+\_\+ex)}{make_ECDHE_client_key_exchange(TLS_parameters_t *TLS_param, client_key_exchange_t *client_key_ex)}}]{\setlength{\rightskip}{0pt plus 5cm}void make\+\_\+\+E\+C\+D\+H\+E\+\_\+client\+\_\+key\+\_\+exchange (
\begin{DoxyParamCaption}
\item[{{\bf T\+L\+S\+\_\+parameters\+\_\+t} $\ast$}]{T\+L\+S\+\_\+param, }
\item[{{\bf client\+\_\+key\+\_\+exchange\+\_\+t} $\ast$}]{client\+\_\+key\+\_\+ex}
\end{DoxyParamCaption}
)}\hypertarget{_t_l_s_8c_a6f7128cf62e8491d70cf2585cf901c4c}{}\label{_t_l_s_8c_a6f7128cf62e8491d70cf2585cf901c4c}
Make the client key exchange message for E\+C\+D\+HE key exchange. This function is called from make\+\_\+client\+\_\+key\+\_\+exchange if the key exchange is E\+C\+D\+HE.
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{_t_l_s_8c_a6f7128cf62e8491d70cf2585cf901c4c_cgraph}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{_t_l_s_8c_a6f7128cf62e8491d70cf2585cf901c4c_icgraph}
\end{center}
\end{figure}
...
Make the server key exchange for E\+C\+D\+HE key exchange. It computes the E\+C\+D\+HE parameters using the secp256k1 curve and save the message in the connection parameters T\+L\+S\+\_\+param.
...
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
the ecdhe\+\_\+server\+\_\+key\+\_\+exchange struct 
\end{DoxyReturn}
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{_t_l_s_8c_ade6994e7ea30d8b5b89b2cd551101db4_cgraph}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{_t_l_s_8c_ade6994e7ea30d8b5b89b2cd551101db4_icgraph}
\end{center}
\end{figure}
...
Given the connection parameters compute the finished message. Note\+: T\+LS protocol requires this message to be encrypted.
...
\begin{center}
\leavevmode
\includegraphics[width=342pt]{_t_l_s_8c_ae149244e09cbbd2180bc4c5fc6d0a924_cgraph}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{_t_l_s_8c_ae149244e09cbbd2180bc4c5fc6d0a924_icgraph}
\end{center}
\end{figure}
...
\subsubsection[{\texorpdfstring{make\+\_\+\+R\+S\+A\+\_\+client\+\_\+key\+\_\+exchange(\+T\+L\+S\+\_\+parameters\+\_\+t $\ast$\+T\+L\+S\+\_\+param, client\+\_\+key\+\_\+exchange\+\_\+t $\ast$client\+\_\+key\+\_\+ex)}{make_RSA_client_key_exchange(TLS_parameters_t *TLS_param, client_key_exchange_t *client_key_ex)}}]{\setlength{\rightskip}{0pt plus 5cm}void make\+\_\+\+R\+S\+A\+\_\+client\+\_\+key\+\_\+exchange (
\begin{DoxyParamCaption}
\item[{{\bf T\+L\+S\+\_\+parameters\+\_\+t} $\ast$}]{T\+L\+S\+\_\+param, }
\item[{{\bf client\+\_\+key\+\_\+exchange\+\_\+t} $\ast$}]{client\+\_\+key\+\_\+ex}
\end{DoxyParamCaption}
)}\hypertarget{_t_l_s_8c_aef2a72a9807aac60336cd3febe51a130}{}\label{_t_l_s_8c_aef2a72a9807aac60336cd3febe51a130}
Make the client key exchange message for R\+SA key exchange. This function is called from make\+\_\+client\+\_\+key\+\_\+exchange if the key exchange is R\+SA.
...
\begin{center}
\leavevmode
\includegraphics[width=332pt]{_t_l_s_8c_aef2a72a9807aac60336cd3febe51a130_cgraph}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{_t_l_s_8c_aef2a72a9807aac60336cd3febe51a130_icgraph}
\end{center}
\end{figure}
...
Given the client hello message the function makes the server hello. It chooses a random cipher suite among those provided by the client. The function also fills the random field using the time stamp and a random generator (Open\+S\+SL)
...
\begin{center}
\leavevmode
\includegraphics[width=338pt]{_t_l_s_8c_a035a830fd89c6c7af60809197d81ea29_cgraph}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{_t_l_s_8c_a035a830fd89c6c7af60809197d81ea29_icgraph}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{_t_l_s_8c_af98aa49e2563d588c366ef1712de925a_icgraph}
\end{center}
\end{figure}
...
Make the server key exchange handshake message. The function also sets the message in the connection parameters to compute the master key in the client key exchange message.
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{_t_l_s_8c_a902d940508d7080023ef072b2667a143_cgraph}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{_t_l_s_8c_a902d940508d7080023ef072b2667a143_icgraph}
\end{center}
\end{figure}

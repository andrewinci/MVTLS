\hypertarget{_crypto_8h}{}\section{include/\+Crypto.h File Reference}
\label{_crypto_8h}\index{include/\+Crypto.\+h@{include/\+Crypto.\+h}}
...
Sign the server\+\_\+key\+\_\+exchange message for a D\+HE key exchange. The function chooses an arbitrary hash algorithm for the signature (except M\+D5, S\+H\+A-\/1). It takes private key in ../certificates/ folder with name server\+A.\+key where A can be R\+SA, D\+SS.
...
\begin{center}
\leavevmode
\includegraphics[width=332pt]{_crypto_8h_aebef13db99f3bbd7e9e2c55df1aa65c9_cgraph}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{_crypto_8h_aebef13db99f3bbd7e9e2c55df1aa65c9_icgraph}
\end{center}
\end{figure}
...
Sign the server\+\_\+key\+\_\+exchange message for a E\+C\+D\+HE key exchange. The function chooses an arbitrary hash algorithm for the signature (except M\+D5, S\+H\+A-\/1). It takes private key in ../certificates/ folder with name server\+A.\+key where A can be R\+SA, E\+C\+D\+SA.
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{_crypto_8h_abe36fc162d9170d061024842f7ec6b9d_cgraph}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{_crypto_8h_abe36fc162d9170d061024842f7ec6b9d_icgraph}
\end{center}
\end{figure}
...
\begin{DoxyParams}{Parameters}
{\em certificate} & the certificate to use to verify the signature \\
\hline
{\em client\+\_\+random} & the random sent by the client in the client hello. Must point to 32 byte stream \\
\hline
{\em server\+\_\+random} & the random sent by the server in the server hello. Must point to 32 byte stream \\
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{_crypto_8h_afbf202296205717442436cd3838d6df7_icgraph}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{_crypto_8h_a5de0523f653b00816828961ba5cc990b_icgraph}
\end{center}
\end{figure}

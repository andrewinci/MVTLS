...
Use the private key ../certificates/server\+D\+SA.key to sign a message


\begin{DoxyParams}{Parameters}
{\em signature} & a pointer to N\+U\+LL, will return the computed signature \\
\hline
{\em signature\+\_\+length} & return the signature length \\
\hline
{\em to\+\_\+sign\+\_\+len} & the message length to sign \\
\hline
{\em to\+\_\+sign} & the message to sign \\
\hline
{\em sign\+\_\+type} & specify the message type (for Open\+S\+SL support) \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
1 if the sign succeeded, -\/1 if an error occurred 
\end{DoxyReturn}
...
Use the private key ../certificates/server\+E\+C\+D\+SA.key to sign a message
...
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
1 if the sign succeeced, -\/1 if an error occurred 
\end{DoxyReturn}
...
Use the private key ../certificates/server\+R\+SA.key to sign a message

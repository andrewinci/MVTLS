...
/*
 * Choose the cipher suite, make server_hello handshake packet
...
handshake * make_server_hello(TLS_parameters *TLS_param, handshake_hello *client_hello){
	// Initialize server_hello (without SessionID)
	...
	*(server_hello->cipher_suites) = choosen_suite;
	...
	// Set cipher_suite in global param
...
/* 
 * Make certificate handshake packet
 */

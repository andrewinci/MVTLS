...
Objects0=$(IntermediateDirectory)/src_Crypto.c$(ObjectSuffix) $(IntermediateDirectory)/src_handshakeConstants.c$(ObjectSuffix) $(IntermediateDirectory)/src_ServerClientBasic.c$(ObjectSuffix) $(IntermediateDirectory)/src_ServerClientHandshakeProtocol.c$(ObjectSuffix) $(IntermediateDirectory)/src_ServerClientRecordProtocol.c$(ObjectSuffix) $(IntermediateDirectory)/src_TLSClient.c$(ObjectSuffix) $(IntermediateDirectory)/src_TLSServer.c$(ObjectSuffix) $(IntermediateDirectory)/HandshakeMessages_Certificate.c$(ObjectSuffix) $(IntermediateDirectory)/HandshakeMessages_ServerClientHello.c$(ObjectSuffix) $(IntermediateDirectory)/HandshakeMessages_ServerClientKeyExchange.c$(ObjectSuffix) \
	$(IntermediateDirectory)/Target_server.c$(ObjectSuffix) 
...
$(IntermediateDirectory)/Target_server.c$(ObjectSuffix): src/Target/server.c $(IntermediateDirectory)/Target_server.c$(DependSuffix)
	$(CC) $(SourceSwitch) "/dati/AdvancedProgramming/src/Target/server.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/Target_server.c$(ObjectSuffix) $(IncludePath)
$(IntermediateDirectory)/Target_server.c$(DependSuffix): src/Target/server.c
	@$(CC) $(CFLAGS) $(IncludePath) -MG -MP -MT$(IntermediateDirectory)/Target_server.c$(ObjectSuffix) -MF$(IntermediateDirectory)/Target_server.c$(DependSuffix) -MM "src/Target/server.c"

$(IntermediateDirectory)/Target_server.c$(PreprocessSuffix): src/Target/server.c
	@$(CC) $(CFLAGS) $(IncludePath) $(PreprocessOnlySwitch) $(OutputSwitch) $(IntermediateDirectory)/Target_server.c$(PreprocessSuffix) "src/Target/server.c"
